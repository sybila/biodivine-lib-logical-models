...
// todo @prototype: this seems to be unused
// /// get the update fn from "data/update_fn_test.sbml"
// /// used in tests / to play around with the code
// #[allow(dead_code)]
// pub fn get_test_update_fn<T: FromStr>() -> SystemUpdateFn<T> {
//     use std::fs::File;
...
//                     let update_fn = SystemUpdateFn::try_from_xml(&mut xml);
...
//     pub fn new(
//         xml: EventReader<BR>,
//         update_fns: &HashMap<String, SystemUpdateFn<u8>>,
//         complain_about_values_too_large: bool,
//         complain_about_unknown_variable_name: bool,
//     ) -> Self {
